...
public class DatabaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Place agh = new Place("Akademia Górniczo-Hutnicza", "al. Mickiewicza 30, 30-059 Kraków, PL",
                50.052652, 19.987345, universities);
        Place uek = new Place("Uniwersytet Ekonomiczny", "Rakowicka 27, 31-510 Kraków, PL",
                50.068464, 19.953883, universities);
        Place pk = new Place("Politechnika Krakowska", "ul. Warszawska 24, 31-355 Kraków, PL",
                50.052652, 19.987345, universities);

        Category busStations = new Category("Dworce autobusowe");
        Place mainStation = new Place("Małopolski Dworzec Autobusowy", "ul. Bosacka 18, 31-505 Kraków, PL",
                50.052652, 19.987345, busStations);
        Place czyzynyStation = new Place("Dworzec Autobusowy Czyżyny", "Medweckiego 15, 31-863 Kraków, PL",
                50.052652, 19.987345, busStations);

        Category museums = new Category("Muzea");
        Place national = new Place("Muzeum Narodowe", "al. 3 Maja 1, 30-062 Kraków, PL",
